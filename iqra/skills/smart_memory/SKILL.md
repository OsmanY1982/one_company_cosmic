...
Iqra 智能记忆技能 - 基于 HERMES 架构的分层记忆系统
...
- 主记忆: `data/iqra/smart_memory/memory.json`
- 偏好档案: `data/iqra/smart_memory/preferences/user-preference-profile.json`
- 快照: `data/iqra/smart_memory/snapshots/`
- 会话状态: `data/iqra/smart_memory/session_state/`
