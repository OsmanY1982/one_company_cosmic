...
from PyQt5.QtWidgets import (
    ...
    QFormLayout, QDialogButtonBox, QToolBar, QAction, QFontComboBox,
    QComboBox, QColorDialog, QMenu, QApplication, QSizePolicy
)
from PyQt5.QtCore import Qt, QTimer, QSize
from PyQt5.QtGui import (
    QFont, QTextCharFormat, QColor, QTextCursor, QTextBlockFormat,
    QPixmap, QTextImageFormat, QIcon, QKeySequence
)
