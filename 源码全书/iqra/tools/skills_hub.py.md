# `iqra/tools/skills_hub.py`

> 路径：`iqra/tools/skills_hub.py` | 行数：3261
...
Used by iqra_cli/skills_hub.py for CLI commands and the /skills slash command.
"""
...
class OptionalSkillSource(SkillSource):
    ...
    def __init__(self):
        from iqra_constants import get_optional_skills_dir
