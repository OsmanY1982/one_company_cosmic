# `iqra/tools/credential_files.py`

> 路径：`iqra/tools/credential_files.py` | 行数：436
...
def _load_config_files() -> List[Dict[str, str]]:
    ...
    try:
        from iqra_cli.config import read_raw_config
        hermes_home = _resolve_hermes_home()
        cfg = read_raw_config()
...
# Each tuple is (new_subpath, old_name) matching iqra_constants.get_hermes_dir().
...
def get_cache_directory_mounts(
    ...
    """
    from iqra_constants import get_hermes_dir
