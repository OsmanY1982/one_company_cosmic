# `iqra/tools/self_monitor.py`

> 路径：`iqra/tools/self_monitor.py` | 行数：114
...
# 项目根目录自动检测（tools/self_monitor.py → iqra/ → one_company_desktop/）
_PROJECT_ROOT = Path(__file__).parent.parent  # iqra/
