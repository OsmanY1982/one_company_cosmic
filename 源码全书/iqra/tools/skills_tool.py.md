# `iqra/tools/skills_tool.py`

> 路径：`iqra/tools/skills_tool.py` | 行数：1533
...
from iqra_constants import get_hermes_home, display_hermes_home
import os
import re
...
def _serve_plugin_skill(
    ...
    *,
    ...
    from iqra_cli.plugins import _get_disabled_plugins, get_plugin_manager
...
def skill_view(
    ...
    try:
        ...
        if ":" in name:
            ...
            from iqra_cli.plugins import discover_plugins, get_plugin_manager
