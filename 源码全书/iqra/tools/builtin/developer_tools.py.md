# `iqra/tools/builtin/developer_tools.py`

> 路径：`iqra/tools/builtin/developer_tools.py` | 行数：263
...
# -*- coding: utf-8 -*-
"""
Iqra 开发者工具 — Claude Code 对标工具集

shell_execute / file_list / file_search / edit_file / project_map
让 Iqra 具备 Terminal + Grep + Edit + LS + Project Map 的完整开发能力
"""
