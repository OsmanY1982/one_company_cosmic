# `iqra/tools/business_tools.py`

> 路径：`iqra/tools/business_tools.py` | 行数：489
...
def register_all_tools(registry, data_dir: str):
    ...
    Usage:
        from iqra.tools.main_tools import register_all_tools
    ...
    # 注册高级分析工具
    try:
        from iqra.tools.analysis_tools import register_analysis_tools
    ...
    # 注册自动化工具
    try:
        from iqra.tools.automation_tools import register_automation_tools
    ...
    # 注册营销推广工具
    try:
        from iqra.tools.marketing_tools import register_marketing_tools
    ...
    # 注册HR管理工具
    try:
        from iqra.tools.hr_tools import register_hr_tools
    ...
    # 注册采购供应链工具
    try:
        from iqra.tools.procurement_tools import register_procurement_tools
    ...
    # 注册文档处理工具
    try:
        from iqra.tools.doc_tools import register_doc_tools
    ...
    # 注册日程管理工具
    try:
        from iqra.tools.scheduling_tools import register_scheduling_tools
    ...
    # 注册AI自检工具
    try:
        from iqra.tools.self_monitor import register_monitor_tools
    ...
    # 注册模板库工具
    try:
        from iqra.tools.template_tools import register_template_tools
    ...
    # 注册财务分析工具
    try:
        from iqra.tools.finance_analysis import register_finance_tools
    ...
    # 注册项目管理工具
    try:
        from iqra.tools.project_management import register_project_management_tools
    ...
    # 注册网络搜索工具
    try:
        from iqra.tools.web_search_tools import register_web_search_tools
    ...
    # 注册智能报告工具
    try:
        from iqra.tools.smart_report_tools import register_smart_report_tools
    ...
    # 注册数据导入工具
    try:
        from iqra.tools.data_import_tools import register_data_import_tools
    ...
    # 注册智能提醒工具
    try:
        from iqra.tools.alert_tools import register_alert_tools
    ...
    # 注册库存管理工具
    try:
        from iqra.tools.inventory_tools import register_inventory_tools
    ...
    # 注册 CRM 增强工具
    try:
        from iqra.tools.crm_tools import register_crm_tools
    ...
    # 注册报表导出工具
    try:
        from iqra.tools.export_tools import register_export_tools
