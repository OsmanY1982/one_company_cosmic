# `iqra/tools/environments/local.py`

> 路径：`iqra/tools/environments/local.py` | 行数：581
...
def _build_provider_env_blocklist() -> frozenset:
    ...
    try:
        from iqra_cli.auth import PROVIDER_REGISTRY
...
def _sanitize_subprocess_env(base_env: dict | None, extra_env: dict | None = None) -> dict:
    ...
    from iqra_constants import get_subprocess_home
