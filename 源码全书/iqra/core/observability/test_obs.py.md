# `iqra/core/observability/test_obs.py`

> 路径：`iqra/core/observability/test_obs.py` | 行数：62
...
if memory._core_memory:
    ...
    print(f"[5/5] IqraMemory records found: {len(found)}")
