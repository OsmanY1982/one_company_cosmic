# `iqra/core/firecrawl/test_self_check.py`

> 路径：`iqra/core/firecrawl/test_self_check.py` | 行数：199
...
sys.path.insert(0, os.path.join(_project_root, "iqra"))
...
try:
    from iqra.core.firecrawl import scrape_url, crawl_site, search_web, extract_structured
...
# 清理旧缓存
from iqra.core.firecrawl.cache import _cache_path
