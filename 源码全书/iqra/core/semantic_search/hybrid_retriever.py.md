# `iqra/core/semantic_search/hybrid_retriever.py`

> 路径：`iqra/core/semantic_search/hybrid_retriever.py` | 行数：242
...
用法:
    from iqra.core.workspace_indexer import WorkspaceIndexer, BM25
    from iqra.core.semantic_search import SemanticSearcher
    from iqra.core.semantic_search.hybrid_retriever import HybridRetriever
...
if TYPE_CHECKING:
    from iqra.core.workspace_indexer import WorkspaceIndexer, SearchResult
    from iqra.core.semantic_search import SemanticSearcher
...
class HybridRetriever:
    ...
    def _semantic_rerank(self, query: str, candidates, top_k: int):
        ...
        """
        from iqra.core.workspace_indexer import SearchResult
