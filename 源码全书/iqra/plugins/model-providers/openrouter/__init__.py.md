# `iqra/plugins/model-providers/openrouter/__init__.py`

> 路径：`iqra/plugins/model-providers/openrouter/__init__.py` | 行数：115
...
class OpenRouterProfile(ProviderProfile):
    ...
    def fetch_models(
        ...
        *,
        ...
        Note: Tool-call capability filtering is applied by iqra_cli/models.py
