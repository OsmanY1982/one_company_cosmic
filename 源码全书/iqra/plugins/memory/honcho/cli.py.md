# `iqra/plugins/memory/honcho/cli.py`

> 路径：`iqra/plugins/memory/honcho/cli.py` | 行数：1456
...
from iqra_cli.config import cfg_get
...
def cmd_sync(args) -> None:
    ...
    """
    try:
        from iqra_cli.profiles import list_profiles
...
def cmd_setup(args) -> None:
    ...
    try:
        from iqra_cli.config import load_config, save_config
...
def _active_profile_name() -> str:
    ...
    try:
        from iqra_cli.profiles import get_active_profile_name
...
def honcho_command(args) -> None:
    ...
    if sub == "setup":
        ...
        from iqra_cli.memory_setup import cmd_setup_provider
