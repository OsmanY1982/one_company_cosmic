# `iqra/plugins/platforms/google_chat/adapter.py`

> 路径：`iqra/plugins/platforms/google_chat/adapter.py` | 行数：3334
...
class GoogleChatAdapter(BasePlatformAdapter):
    ...
    def __init__(self, config: PlatformConfig):
        ...
        try:
            from iqra_constants import get_hermes_home as _get_hermes_home
...
def interactive_setup() -> None:
    ...
    The setup wizard at ``iqra_cli/gateway.py`` calls this for plugin
    ...
    """
    from iqra_cli.cli_output import (
        print_info,
        print_success,
        print_warning,
        prompt,
    ...
    from iqra_cli.config import get_env_value, save_env_value
