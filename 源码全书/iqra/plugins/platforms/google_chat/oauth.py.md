# `iqra/plugins/platforms/google_chat/oauth.py`

> 路径：`iqra/plugins/platforms/google_chat/oauth.py` | 行数：638
...
try:
    from iqra_constants import display_hermes_home, get_hermes_home
except (ModuleNotFoundError, ImportError):
    # Fallback for environments where iqra_constants isn't importable
