# `iqra/agent/model_metadata.py`

> 路径：`iqra/agent/model_metadata.py` | 行数：1569
...
from iqra_constants import OPENROUTER_MODELS_URL
...
def get_model_context_length(
    ...
    if custom_providers and base_url and model:
        try:
            from iqra_cli.config import get_custom_provider_context_length
    ...
    if effective_provider in ("copilot", "copilot-acp", "github-copilot"):
        try:
            from iqra_cli.models import get_copilot_model_context
