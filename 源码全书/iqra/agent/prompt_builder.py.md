# `iqra/agent/prompt_builder.py`

> 路径：`iqra/agent/prompt_builder.py` | 行数：1448
...
from iqra_constants import get_hermes_home, get_skills_dir, is_wsl
...
def build_nous_subscription_prompt(valid_tool_names: "set[str] | None" = None) -> str:
    ...
    try:
        from iqra_cli.nous_subscription import get_nous_subscription_features
...
def load_soul_md() -> Optional[str]:
    ...
    """
    try:
        from iqra_cli.config import ensure_hermes_home
        ensure_hermes_home()
    except Exception as e:
