# `iqra/web_ui/harness/__init__.py`

> 路径：`iqra/web_ui/harness/__init__.py` | 行数：346
...
class HarnessHandler(BaseHTTPRequestHandler):
    ...
    def _handle_save(self, agent_id: str, data: dict):
        ...
        if h is None:
            ...
            return
        try:
            from iqra.core.harness.config_schema import AgentConfig
