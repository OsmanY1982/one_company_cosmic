# `iqra/skills/flybook_bot/server_minimal.py`

> 路径：`iqra/skills/flybook_bot/server_minimal.py` | 行数：207
...
from iqra.core.llm_backend import ProviderConfig, OpenAICompatibleBackend
...
if __name__ == '__main__':
    print("=" * 60)
    print("Iqra HTTP API Server (最小测试版)")
    print("=" * 60)
