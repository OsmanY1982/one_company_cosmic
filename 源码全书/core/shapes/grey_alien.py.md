...
> 路径：`core/shapes/grey_alien.py` | 行数：235
...
def paint(painter: QPainter, center: QPointF, radius: float,
    ...
    for _ in range(22):
        ...
        ag.setColorAt(0.5, QColor(140//2, 150//2, 190, a_alpha // 2))
...
# ── 悬停增强（主题色脉冲光晕 + 呼吸轮廓）──
    if hovered:
        ...
        for i in range(3):
            ...
            ig.setColorAt(0.78, QColor(140, 150, 160, ga // 2))
            ig.setColorAt(0.90, QColor(140, 150, 160, ga))
            ig.setColorAt(0.97, QColor(140//2, 150//2, 190, ga // 3))
        ...
        for i in range(3):
            ...
            og.setColorAt(0.88, QColor(140, 150, 160, ga // 2))
            og.setColorAt(0.96, QColor(140//2, 150//2, 200, ga // 3))
        ...
        rpen = QPen(QColor(140, 150, 160, int(220 * hp * br)), 2.5 + 1.0 * br)
