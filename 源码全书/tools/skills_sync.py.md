...
> 路径：`tools/skills_sync.py` | 行数：452
...
# ═══════════════════════════════════════════
#  SkillsSync wrapper class for cosmic import
# ═══════════════════════════════════════════

class SkillsSync:
    """Skills sync wrapper class for cosmic project integration."""
    ...
    def run_sync(self, quiet: bool = True) -> dict:
        return sync_skills(quiet=quiet)

    def reset_skill(self, name: str, restore: bool = False) -> dict:
        return reset_bundled_skill(name, restore=restore)
