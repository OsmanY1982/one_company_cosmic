# `modules/industry/industry_report.py`

> 路径：`modules/industry/industry_report.py` | 行数：198
...
from modules.industry.industry_adapter import get_adapter
...
class IndustryReportGenerator:
    ...
    def _fetch_daily_data(self) -> Dict:
        """获取日报数据"""
        try:
            from modules.intelligence.db_helper import get_db_helper
