# `modules/personnel/distribution_service.py`

> 路径：`modules/personnel/distribution_service.py` | 行数：417
...
def add_commission(user_id: int, amount: float, from_user_id: int = None,
    ...
    from modules.personnel.wallet_service import add_commission as wallet_add_commission
