# `modules/auth/model_setup_window.py 14-25-19-598.py`

> 路径：`modules/auth/model_setup_window.py 14-25-19-598.py` | 行数：711
...
PRESET_PROVIDERS = [
    ...
    {"id": "bailian",         "name": "阿里云百炼",         "base_url": "https://dashscope.aliyuncs.com/compatible-mode/v1", "model": "qwen-plus",   "desc": "百炼 MaaS 平台 — 157+ 模型" ,                  "local": False, "models": ["qwen-plus", "deepseek-v4-pro", "kimi-k2.6"]},
