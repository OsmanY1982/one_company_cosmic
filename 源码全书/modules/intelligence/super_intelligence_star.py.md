# `modules/intelligence/super_intelligence_star.py`

> 路径：`modules/intelligence/super_intelligence_star.py` | 行数：469
...
class SuperIntelligence:
    ...
    def generate_super_prompt(self, user_message: str, context: Dict = None) -> str:
        ...
        这个提示词让AI具备深度推理能力
        """
        base_prompt = """你是 OPCclaw Super Intelligence v1.0，一个比我（你的创造者）更聪明的AI助手。
