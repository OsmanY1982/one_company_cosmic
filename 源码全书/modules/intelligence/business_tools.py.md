# `modules/intelligence/business_tools.py`

> 路径：`modules/intelligence/business_tools.py` | 行数：489
...
def register_all_tools(registry, data_dir: str):
    ...
    Usage:
        from modules.intelligence.tools.main_tools import register_all_tools
    ...
    # 注册自动化工具
    try:
        from modules.intelligence.tools.automation_tools import register_automation_tools
    ...
    # 注册采购供应链工具
    try:
        from modules.intelligence.tools.procurement_tools import register_procurement_tools
    ...
    # 注册文档处理工具
    try:
        from modules.intelligence.tools.doc_tools import register_doc_tools
    ...
    # 注册日程管理工具
    try:
        from modules.intelligence.tools.scheduling_tools import register_scheduling_tools
    ...
    # 注册模板库工具
    try:
        from modules.intelligence.tools.template_tools import register_template_tools
    ...
    # 注册财务分析工具
    try:
        from modules.intelligence.tools.finance_analysis import register_finance_tools
    ...
    # 注册项目管理工具
    try:
        from modules.intelligence.tools.project_management import register_project_management_tools
    ...
    # 注册网络搜索工具
    try:
        from modules.intelligence.tools.web_search_tools import register_web_search_tools
    ...
    # 注册智能提醒工具
    try:
        from modules.intelligence.tools.alert_tools import register_alert_tools
    ...
    # 注册报表导出工具
    try:
        from modules.intelligence.tools.export_tools import register_export_tools
