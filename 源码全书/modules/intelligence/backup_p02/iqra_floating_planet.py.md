# `modules/intelligence/backup_p02/iqra_floating_planet.py`

> 路径：`modules/intelligence/backup_p02/iqra_floating_planet.py` | 行数：1335
...
class FloatingPlanet(QWidget):
    ...
    def __init__(self, iqra_engine=None,
        ...
        # 提示标签（休眠态悬浮显示）
        self._tooltip = QLabel("iqra", self)
    ...
    def _switch_to_shape(self, category: str, key: str):
        ...
        self._tooltip.setText(f"iqra · {name}")
