# `modules/intelligence/_model_manager.py`

> 路径：`modules/intelligence/_model_manager.py` | 行数：9
...
from modules.intelligence._model_manager_download import DownloadModelDialog, DownloadWorker
