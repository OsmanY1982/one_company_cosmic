# `modules/account/account_activation.py`

> 路径：`modules/account/account_activation.py` | 行数：607
...
from modules.account.license_local import (
    init_activation_db, CODE_TYPES, _normalize, _format_code, DB_FILE, activate_license
)
from modules.account.activation_service import (
...
class AccountActivationWindow(QDialog):
    ...
    def _open_stats(self):
        from modules.account.activation_stats import ActivationStatsWindow
    ...
    def _activate_user(self):
        ...
        from modules.account.license_local import activate_license
