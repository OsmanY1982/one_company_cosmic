# `solar_explorer/star_catalog_window.py`

> 路径：`solar_explorer/star_catalog_window.py` | 行数：290
...
from solar_explorer.body_encyclopedia import get_all_entries, get_statistics
...
class StarCatalogWindow(QWidget):
    ...
    def _on_item_clicked(self, item):
        ...
        if entry:
            from solar_explorer.body_detail_window import BodyDetailWindow
