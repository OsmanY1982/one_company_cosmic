# `astronomy/star_catalog/catalog.py`

> 路径：`astronomy/star_catalog/catalog.py` | 行数：290
...
from astronomy.star_catalog.encyclopedia import get_all_entries, get_statistics
...
class StarCatalogWindow(QWidget):
    ...
    def _on_item_clicked(self, item):
        ...
        if entry:
            from astronomy.star_catalog.detail import BodyDetailWindow
