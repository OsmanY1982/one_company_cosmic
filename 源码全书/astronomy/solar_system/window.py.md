# `astronomy/solar_system/window.py`

> 路径：`astronomy/solar_system/window.py` | 行数：455
...
from astronomy.solar_system.data import (
...
class SolarSystemWindow(QWidget):
    ...
    def _open_catalog(self):
        from astronomy.star_catalog.catalog import StarCatalogWindow
