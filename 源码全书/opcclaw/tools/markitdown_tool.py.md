# `opcclaw/tools/markitdown_tool.py`

> 路径：`opcclaw/tools/markitdown_tool.py` | 行数：131
...
into the opcclaw tool registry.  Supports conversion of:
...
from opcclaw.tools.registry import registry
