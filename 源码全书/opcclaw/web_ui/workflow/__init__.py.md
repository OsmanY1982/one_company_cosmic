# `opcclaw/web_ui/workflow/__init__.py`

> 路径：`opcclaw/web_ui/workflow/__init__.py` | 行数：251
...
class WorkflowHandler(BaseHTTPRequestHandler):
    ...
    def _handle_run(self, data: dict):
        ...
        try:
            ...
            script_path = os.path.join(tmpdir, "_opcclaw_workflow_run.py")
