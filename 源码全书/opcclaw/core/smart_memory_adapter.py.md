...
> 路径：`opcclaw/core/smart_memory_adapter.py` | 行数：468
...
class SmartMemoryStore:
    ...
    # ================================================================
    # 核心持久化记忆代理（OPCclawMemory SQLite）
    # ================================================================

    @property
    def core_memory(self):
        """获取底层 OPCclawMemory 实例（供 enhanced_core 降级场景使用）"""
