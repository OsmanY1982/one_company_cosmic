...
> 路径：`opcclaw/core/llm_backend.py` | 行数：953
...
PROVIDER_TEMPLATES = {
    ...
    "ollama": ProviderConfig(
        ...
        available_models=[
            "qwen2.5:7b-64k",       # 7.6B, 上下文 32k, 支持 tools
            "gemma4-hermes:latest",  # 11.9B, 上下文 262k, 支持 tools/thinking/vision
            "qwen3.6-35b-iq4xs:latest",   # 34.7B, 上下文 262k
            "qwen3.6-35b-vl:latest",      # 34.7B, 上下文 262k, 支持 vision
            "qwen3.6-35b-uncensored-fast:latest",  # 34.7B
            "qwen3.6-35b-q2kp:latest",    # 34.7B
            "qwen3.6-35b-iq2m:latest",    # 34.7B
            # 常用推荐模型
            "qwen2.5:14b", "qwen2.5:32b",
            "llama3.2:3b", "llama3.2:1b",
            "gemma2:9b", "gemma2:27b",
            "deepseek-r1:7b", "deepseek-r1:14b",
            "deepseek-coder-v2:16b", "codestral:22b",
            "mistral:7b", "phi4:14b", "nomic-embed-text",
        ],
    ),
...
def create_backend(
    ...
    base_url: str = "",
    temperature: float = 0.7,
    max_tokens: int = 2048,) -> BaseLLMBackend:
    """
    一行创建 LLM 后端。
