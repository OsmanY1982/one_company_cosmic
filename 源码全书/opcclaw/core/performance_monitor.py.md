# `opcclaw/core/performance_monitor.py`

> 路径：`opcclaw/core/performance_monitor.py` | 行数：330
...
```python
"""
OPCclaw Performance Monitor & Structured Logging
...
class PerformanceMonitor:
    """Global performance monitor for OPCclaw."""
