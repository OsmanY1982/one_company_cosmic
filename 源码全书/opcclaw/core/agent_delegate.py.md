# `opcclaw/core/agent_delegate.py`

> 路径：`opcclaw/core/agent_delegate.py` | 行数：665
...
# -*- coding: utf-8 -*-
"""
OPCclaw Agent Delegate — LLM 驱动的智能子代理委派系统
...
用法:
    from opcclaw.core.agent_delegate import AgentDelegate, SubAgentTask
    from opcclaw.core.llm_backend import create_backend
