# `opcclaw/core/test_phase2.py`

> 路径：`opcclaw/core/test_phase2.py` | 行数：87
...
```python
"""Phase 2 集成测试 — 独立于 opcclaw 包导入"""
import sys, os, tempfile

# Direct module loading
sys.path.insert(0, os.path.dirname(os.path.dirname(os.path.abspath(__file__))))

# Load workspace_indexer without triggering opcclaw/__init__.py
...
# ── Test 1: Index OPCclaw codebase ──
print("=" * 60)
print("Test 1: Full index of OPCclaw")
