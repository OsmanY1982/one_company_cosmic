# `opcclaw/core/multi_channel/__init__.py`

> 路径：`opcclaw/core/multi_channel/__init__.py` | 行数：420
...
使用前先注册平台适配器:
    from opcclaw.core.multi_channel.platforms.wechat import WechatAdapter
