# `opcclaw/core/secure_storage.py`

> 路径：`opcclaw/core/secure_storage.py` | 行数：434
...
# Keychain 常量
_KEYCHAIN_SERVICE = "com.opcclaw.secure-storage"
...
class SecureStorage:
    ...
    def __init__(self, app_name: str = "opcclaw", bind_machine: bool = False):
        """
        Args:
...
if __name__ == "__main__":
    ...
    print("=== OPCclaw Secure Storage Test (macOS Keychain) ===")
