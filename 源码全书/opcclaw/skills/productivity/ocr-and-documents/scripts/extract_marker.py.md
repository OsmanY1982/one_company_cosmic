# `opcclaw/skills/productivity/ocr-and-documents/scripts/extract_marker.py`

> 路径：`opcclaw/skills/productivity/ocr-and-documents/scripts/extract_marker.py` | 行数：87
