# `opcclaw/skills/qclaw_skills/wecom-weisheng-scrm/scripts/get_access_token.py`

> 路径：`opcclaw/skills/qclaw_skills/wecom-weisheng-scrm/scripts/get_access_token.py` | 行数：158
