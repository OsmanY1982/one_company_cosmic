# `opcclaw/skills/qclaw_skills/video-image-file-analysis/scripts/vision.py`

> 路径：`opcclaw/skills/qclaw_skills/video-image-file-analysis/scripts/vision.py` | 行数：80
