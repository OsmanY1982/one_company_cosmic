# `opcclaw/skills/flybook_bot/server_simple.py`

> 路径：`opcclaw/skills/flybook_bot/server_simple.py` | 行数：177
...
```python
"""
OPCclaw HTTP API Server - 简化版（无浏览器）
==========================================
...
from opcclaw.core.core_engine import OPCclawCoreEngine
...
if __name__ == '__main__':
    print("=" * 60)
    print("OPCclaw HTTP API Server (简化版)")
    print("=" * 60)
