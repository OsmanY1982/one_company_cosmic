# OPCclaw HTTP API Server - 浏览器自动化
...
```bash
python D:/one_company_desktop/opcclaw/skills/flybook_bot/server.py
```
...
```bash
python D:/one_company_desktop/opcclaw/skills/flybook_bot/test_server.py
```
