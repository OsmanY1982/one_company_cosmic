...
PROVIDER_TEMPLATES = {
    ...
    "ollama": ProviderConfig(
        ...
        available_models=["qwen2.5:7b", "qwen2.5:14b", "qwen2.5:32b", "llama3.2:3b", "llama3.2:1b", "gemma2:9b", "gemma2:27b", "deepseek-r1:7b", "deepseek-r1:14b", "deepseek-coder-v2:16b", "codestral:22b", "mistral:7b", "phi4:14b", "nomic-embed-text"],
    ),
